...
const AccountHeader = ( ) => {
  ...
  const content = {
    ...
    menuItems: [
      { icon: <FaWallet />, text: { en: "Wallet", bn: "ওয়ালেট" }, link: "/wallet" },
      { icon: <RiLuggageDepositLine />, text: { en: "Deposit", bn: "ডিপোজিট" }, link: "/" },
      { icon: <BiMoneyWithdraw />, text: { en: "Withdraw", bn: "উত্তোলন" }, link: "/" },
      { icon: <RiVipCrownFill />, text: { en: "VIP", bn: "ভিআইপি" }, link: "/" },
    ],
  };

  return (
    <div className="relative">
      <div className="flex justify-center gap-2 bg-red pb-[40%]">
        ...
        <div className="flex text-white gap-1 flex-col items-start justify-center">
          ...
          <button className="rounded-full p-1 flex items-center gap-2 text-white text-xs bg-accountYellow">
            <p>UID |</p>
            <p>1000251</p>
            <span>
              <FaRegCopy />
      ...
      <div className="flex absolute text-xs md:text-sm top-28 left-1/2 transform -translate-x-1/2 bg-white shadow-2xl justify-center space-x-1 rounded-lg">
        <div className="flex flex-col px-2 pt-3 pb-16">
